...
export const getUserContext = (requestContext) => ({
  username: getUsername(requestContext),
  groups: getUserGroups(requestContext),
  claims: getClaims(requestContext),
});
...
export const DEFAULT_RENAME = { pk: 'id', sk: 'username' };
